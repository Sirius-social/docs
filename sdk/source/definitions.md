...
Sirius SDK позволяет создавать приватный DID следующим образом
```python
...
приложения при помощи Sirius SDK.

Для подключения и управления облачным агентом в Sirius SDK достаточно вызвать следующую команду
```python
